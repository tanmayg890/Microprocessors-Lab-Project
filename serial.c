...
void uart_init(void)
{
	TMOD=TMOD & 0x2F;
	TMOD= TMOD | 0x20;
	 TH1=204;         			//Configure Timer 1 in Mode 2
	//TH1=__;					//Load TH1 to obtain required Baudrate (Refer Serial.pdf for calculations)
	
	
	SCON=0x40;			//Configure UART peripheral for 8-bitdatatransfer 
